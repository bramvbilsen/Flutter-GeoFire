package com.vanbilsen.bram.flutter.geofire.fluttergeofireplugin;
 ...
 * GeofirePlugin
 */
public class FlutterGeofirePlugin implements MethodCallHandler {
  /**
   * Plugin registration.
   */
  public static void registerWith(Registrar registrar) {
    ...
    final FlutterGeofirePlugin instance = new FlutterGeofirePlugin(registrar.activity(), registrar, channel, queryListenerChannel);
    channel.setMethodCallHandler(instance);
  }

  FlutterGeofirePlugin(Activity activity, Registrar registrar, MethodChannel channel, MethodChannel queryChannel) {
